...
public class AppUser implements UserDetails {
    ...
    @SequenceGenerator(name = "user_sequance", sequenceName = "user_sequance", allocationSize = 1)
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "user_sequance")
    private Long id;
